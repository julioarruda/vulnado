...
public class Comment {
  ...
  public static List<Comment> fetchAll() {
    ...
    try {
      ...
      Logger.getLogger(Comment.class.getName()).log(Level.SEVERE, "Error fetching comments", e);
    } finally {
      return comments;
    }
  }
  ...
  public static boolean delete(String id) {
    try (Connection con = Postgres.connection();
      ...
      Logger.getLogger(Comment.class.getName()).log(Level.SEVERE, "Error deleting comment", e);
      return false;
  }
