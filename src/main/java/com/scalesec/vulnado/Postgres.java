...
public class Postgres {
    ...
    public static Connection connection() {
        try {
            // Class.forName("org.postgresql.Driver"); // Removed as it's unnecessary in modern JDBC
    ...
    public static void setup(){
        try {
            ...
            LOGGER.severe("Exiting application due to database setup failure.");
        }
    }
    ...
    {
        // This method uses MD5 which is not recommended for secure hashing
