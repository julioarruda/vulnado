...
class UserTest {
    ...
    void setUp() {
        ...
        testUser = new User("1", "testUser", BCrypt.hashpw("password", BCrypt.gensalt()));
    }
    ...
    void fetch_ShouldHandleSQLException() throws Exception {
        ...
        assertTrue(errContent.toString().contains("Erro ao buscar o usuário: SQL Error"), "Fetch should print error message to stderr");
    ...
    void hashPassword_ShouldGenerateValidBCryptHash() {
        ...
        assertTrue(BCrypt.checkpw(password, hashedPassword), "hashPassword should generate a valid BCrypt hash");
    }
